declare module enchant {
    ...
    class Surface extends EventTarget
    {
         ...
         */
        draw(image:Surface);
        draw(image:Surface, imageX:number, imageY:number);
        draw(image:Surface, imageX:number, imageY:number, imageW:number, imageH:number, destX:number, destY:number, destW:number, destH:number);
                /**
         * Copies Surface.
